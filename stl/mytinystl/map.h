...
public:
    friend bool operator==(const map& lhs, const map& rhs) { return lhs.tree_ == rhs.tree; }
...
public:
    friend bool operator==(const multimap& lhs, const multimap& rhs) { return lhs.tree_ == rhs.tree; }
